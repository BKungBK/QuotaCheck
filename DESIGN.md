...
**Key Characteristics:**
- **Sleek Utility**: Flat dark grays with a sharp bright blue progress bar indicator.
...
The color palette is composed of high-contrast dark grays serving as the container canvas, accented by a single bright blue for active state metrics.

### Primary
- **Active Blue** (#007acc): Used for progress indicators, active quota highlights, and success status elements.

### Neutral
- **IDE Dark Canvas** (#1e1e1e): The main background color of the widget, ensuring it sits comfortably on both dark and light wallpapers.
- **Surface Container** (#2d2d2d): Subtle background highlights or dividers.
- **Ink Primary** (#ffffff): The high-contrast text color for active quota numbers.
- **Ink Muted** (#969696): Muted label text, secondary time indicators, or offline warning icons.
- **Border Gray** (#333333): The thin boundary separating card sections or outer frames.

**The Singularity Rule.** Only the active progress bar and current remaining count may use the Active Blue accent. All other labels and metadata must remain in Neutral colors.
...
**The Flat-Surface Rule.** No drop shadows are allowed on the widget container. Separation from the wallpaper is achieved strictly via the thin Border Gray outline and the solid IDE Dark background.

## 5. Components

### Widget Container
- **Shape:** Rounded corners (8px)
- **Background:** IDE Dark Canvas (#1e1e1e)
- **Border:** 1px solid Border Gray (#333333)
- **Padding:** 12px internally

### Progress Bar
- **Track:** 1px solid Border Gray (#333333) or dark neutral container.
- **Indicator:** Active Blue (#007acc) fill with a smooth 300ms CSS width transition.
